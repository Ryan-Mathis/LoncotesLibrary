    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "123 Main St", "Ryan@Mail.com", "Ryan", true, "Mathis" },
                    { 2, "456 Second Ave", "Simone@Mail.com", "Simone", false, "Henderson" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "At The Mountains Of Madness", 1, null },
                    { 2, 5, "The Way of Kings", 1, null },
                    { 3, 4, "Dune", 1, null },
                    { 4, 6, "GQ", 3, null },
                    { 5, 5, "The Lord Of The Rings: The Fellowship of the Ring", 1, null },
                    { 6, 5, "The Lord Of The Rings: The Two Towers", 1, null },
                    { 7, 5, "The Lord Of The Rings: The Return of the King", 1, null },
                    { 8, 5, "The Lord Of The Rings: The Fellowship of the Ring", 2, null },
                    { 9, 5, "The Lord Of The Rings: The Two Towers", 2, null },
                    { 10, 5, "The Lord Of The Rings: The Return of the King", 2, null },
                    { 11, 3, "Encyclopedia Brown Takes the Case", 1, new DateTime(1994, 8, 25, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 12, 2, "I, Claudius", 1, null }
                });
